...
public class DescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // toolbar = findViewById(R.id.VillageToolbar);
        ...
        DatabaseReference pack = reference.child("Packages").child("Landour");
        reference = reference.child("Villages").child("Landour");
        try {
            ...
            pack.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    btv = dataSnapshot.child("Best time to visit").getValue().toString();
